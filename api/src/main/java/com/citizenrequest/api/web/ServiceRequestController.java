...
public class ServiceRequestController {
    ...
    public List<RequestStatusHistoryDto> findPublicRequestHistory(
            @PathVariable Long requestId
    ) {
    ...
    public List<RequestCommentDto> findRequestComments(
            @PathVariable Long requestId
    ) {
    ...
    public ServiceRequestDto toggleVote(
            @PathVariable Long requestId,
    ...
    public List<ServiceRequestDto> findMyRequests(
            @PathVariable Long citizenId
    ) {
...
// =========================
    ...
    public AiTriageResultDto triageRequest(
            @PathVariable Long requestId
    ) {
    ...
    public AiTriageResultDto findAiTriageByRequestId(
            @PathVariable Long requestId
    ) {
