...
public class AiTriageServiceImpl implements AiTriageService {
    ...
    public AiTriageResultDto triageRequest(Long requestId) {
        ...
        Department suggestedDepartment = departmentRepository.findById(prediction.departmentId())
        ...
        AiTriageResult result = AiTriageResult.builder()
        ...
        requestStatusHistoryService.recordChange(
                ...
                suggestedDepartment,
                null,
                "AI triage suggested department: " + suggestedDepartment.getName()
    ...
    public AiTriageResultDto declineSuggestedDepartment(
        ...
        if (!request.getDepartment().getId().equals(employee.getDepartment().getId())) {
            throw new RuntimeException("Employee can only decline requests assigned to their department.");
        }
    ...
    public AiTriageResultDto adminReviseDepartment(
        ...
        boolean changedFromAiSuggestion = result.getSuggestedDepartment() != null
    ...
    private AiTriageResult findTriageResultByRequestId(Long requestId) {
        return aiTriageResultRepository.findByServiceRequestId(requestId)
