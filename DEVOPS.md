...
DevOps.pdf
60.72 KB
this is just if anyone is curious on what I'm planning to do on my side
I'll handle all of this so no worries at all
David — 01/04/2026, 18:08
if you guys have started on anything tell me so I can start too
and a repository too
﻿
# DevOps plan
## Why?
Adhereing to these standards will not take away our pain, but make it very very less severe. We're going to catch issues early, make code readable, and automate (almost) everything.
